...
const uint8_t PROGMEM bach[]  = "!T110 L8 a gafaeada c+adaeafa >aa>bac#ada c#adaeaf4";

const uint8_t PROGMEM guminam[] = "!T160 L2 a1aa1age+ e1rd>cb-a4b-4 b-1rd>cb-4b-.a4b-4 b-rd.e.f a1b-g1f1 g1. rffe4d.ff1.";

const uint8_t PROGMEM cmajor[] = "!T110 L16 cdefgab>cbagfedc";

const uint8_t PROGMEM ledCharSet[]  = // put these characters in PROGMEM, to save RAM.
	   {
...
/*
const uint8_t PROGMEM Picture[]  = // put these characters in PROGMEM, to save RAM.
{
