...
int8_t *pcAllocatedBuffer;
	...
	{
		pxNewQueue = ( Queue_t * ) pcAllocatedBuffer; /*  The buffer cannot be to small because it was dimensioned by sizeof( Queue_t ) + xQueueSizeInBytes. */
...
Queue_t * const pxQueue = ( Queue_t * ) xQueue;
	...
	return pdTRUE; // execution never reaches here.
}
/*-----------------------------------------------------------*/
