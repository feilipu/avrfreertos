...
// RAM0 is upper device on the board (lower address)
// RAM1 is lower device on the board
...
/**********************************************************************/
#if 1
// xxx SPI Slave Select lines are Port C4 and C5 respectively on Goldilocks Analogue
