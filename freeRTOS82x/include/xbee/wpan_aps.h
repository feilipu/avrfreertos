...
typedef PACKED_STRUCT wpan_cluster_table_entry_t {
...
typedef PACKED_STRUCT wpan_endpoint_table_entry_t
{
...
*/
typedef PACKED_STRUCT wpan_dev_t {
...
void wpan_envelope_create( wpan_envelope_t *envelope, wpan_dev_t *dev,
	const addr64_t FAR *ieee, uint16_t network_addr);
...
typedef struct wpan_conversation_t {
	...
	uint16_t			timeout;				// time to expire conversation
...
typedef PACKED_STRUCT wpan_ep_state_t {
